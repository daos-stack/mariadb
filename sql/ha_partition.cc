...
int ha_partition::notify_tabledef_changed(LEX_CSTRING *db, LEX_CSTRING *table,
                                          LEX_CUSTRING *frm,
                                          LEX_CUSTRING *version)
{
  char from_buff[FN_REFLEN + 1], from_lc_buff[FN_REFLEN + 1], from[FN_REFLEN+1];
  ...
  strxmov(from, db->str, FN_ROOTDIR, table->str, NullS);
